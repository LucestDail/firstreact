                ...
                <div style={{ alignSelf: 'stretch', height: 52, paddingLeft: 16, paddingRight: 8, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', display: 'flex' }}>
                    <div style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex' }}>
                        <div style={{ flex: '1 1 0', height: 20, justifyContent: 'flex-start', alignItems: 'center', gap: 2, display: 'flex' }}>
                            <div style={{ color: '#1A1A1A', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '500', lineHeight: 20, wordWrap: 'break-word' }}>필수입력</div>
                        </div>
                    ...
                    <div style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'inline-flex' }}>
                        <div style={{ color: '#999999', fontSize: 11, fontFamily: 'Noto Sans KR', fontWeight: '700', lineHeight: 14, wordWrap: 'break-word' }}>TYPE : PARAMETER</div>
                        <div style={{ color: '#999999', fontSize: 11, fontFamily: 'Noto Sans KR', fontWeight: '700', lineHeight: 14, wordWrap: 'break-word' }}>BOXID : PA010</div>
                    </div>
                </div>
                <div style={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 12, display: 'flex' }}>
                    <div style={{ height: 122, padding: 8, background: '#F7F7F7', borderTopLeftRadius: 4, borderTopRightRadius: 4, borderBottomRightRadius: 4, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8, display: 'flex' }}>
                        ...
                        <div style={{ alignSelf: 'stretch', height: 82, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 4, display: 'flex' }}>
                            <div style={{ alignSelf: 'stretch', paddingTop: 4, paddingBottom: 4, borderRadius: 4, justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex' }}>
                                <div style={{ width: 16, height: 16, position: 'relative' }}>
                                    <div style={{ width: 12.45, height: 12.80, left: 1.77, top: 1.60, position: 'absolute', background: '#999999' }}></div>
                                </div>
                                <div style={{ flex: '1 1 0', color: '#B3B3B3', fontSize: 13, fontFamily: 'Noto Sans KR', fontWeight: '400', lineHeight: 18, wordWrap: 'break-word' }}>필수 슬롯 지정</div>
                            </div>
                            <div style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex' }}>
                            ...
                            <div style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex' }}>
                                <div style={{ flex: '1 1 0', height: 32, padding: 8, background: '#FCFCFC', borderRadius: 4, border: '2px #1760CC solid', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'flex' }}>
                                    <div style={{ width: 16, height: 16, position: 'relative' }}>
